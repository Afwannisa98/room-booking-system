...
<div class="container mt-5">
    <div class="container-box">
        <h2 class="text-center mb-4">Add A Room <i class="bi bi-door-open-fill"></i></h2>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="location" class="form-control" value="<?= set_value('location') ?>" required>
        </div>

        <div class="mb-3">
            <label for="name" class="form-label">
                <i class="bi bi-person-fill"></i> Capacity</label> 
            <input type="text" name="capacity" class="form-control" value="<?= set_value('capacity') ?>" required>
        </div>

        <div class="mb-3">
            <label for="name" class="form-label">
                <i class="bi bi-person-fill"></i> Facilities</label> 
            <input type="text" name="facilities" class="form-control" value="<?= set_value('facilities') ?>" required>
        </div>
